...
(Ubuntu 22.04 или 24.04) с привязкой домена. Все команды — в **вашем** терминале,
...
- Арендованный VPS с Ubuntu 22.04 или 24.04 (у Timeweb Cloud — образ "Ubuntu", версия 24.04; 26.04 пока слишком свежая, некоторые сторонние пакеты могут не успеть под неё адаптироваться).
