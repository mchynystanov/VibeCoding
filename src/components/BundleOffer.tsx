export function BundleOffer() {
  return (
    <div className="bundle-offer-glow h-full rounded-2xl bg-gradient-to-r from-paomma-rose to-paomma-surface p-6 sm:p-8">
      ...
      <p className="mt-2 text-sm text-paomma-inkMuted">
        Купите вместе — дополнительная скидка на комплект применится автоматически в корзине.
